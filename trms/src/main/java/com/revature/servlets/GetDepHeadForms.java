...
/**
 * Servlet implementation class GetDepHeadForms
 */
public class GetDepHeadForms extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		else
		{
			...
			List<RequestForm> incompleteForms = rHandler.getFormsForDepartmentHeadApproval(employee.getId());
